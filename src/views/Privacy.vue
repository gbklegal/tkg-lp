...
document.title = 'Datenschutz - TKG';
</script>

<template>
    <TheHero title="Datenschutz" />
    <div class="prose mb-12 px-10">
        <h3>1. Name und Kontaktdaten des für die Verarbeitung Verantwortlichen</h3>
        <p>
            Diese Datenschutzhinweise gelten für die Datenverarbeitung durch:<br /><br />
            Verantwortlicher:<br /><br />
            TKG Verwaltungsgesellschaft GmbH<br />
            (im Folgenden ggf. auch: „TKG“ oder „wir“),<br /><br />
            vertreten durch den Geschäftsführer Herrn Tobias Gußmann,<br /><br />
            Büroanschrift: Kaiserstraße 23, 90403 Nürnberg, Deutschland<br /><br />
            Sitz: Nürnberg<br /><br />
            Handelsregister: Amtsgericht Nürnberg, HRB Nürnberg 32830<br /><br />
            E-Mail: dialog@tkgad.com<br /><br />
            Telefon: +49 (0) 30 213 005 919
        </p>
        ...
        <p>Beim Aufrufen unserer Website www.tkgad.de werden durch den auf Ihrem Endgerät zum Einsatz kommenden Browser automatisch Informationen an den Server unserer Website gesendet. Diese Informationen werden temporär in einem sog. Logfile gespeichert. Folgende Informationen werden dabei ohne Ihr Zutun erfasst und bis zur automatisierten Löschung gespeichert:</p>
        <ul>
        ...
        <p>Die für die Benutzung des Kontaktformulars von uns erhobenen personenbezogenen Daten werden nach Erledigung der von Ihnen gestellten Anfrage automatisch gelöscht, sofern Sie uns nicht die Einwilligung zur Weitergabe Ihrer Daten erteilt haben.</p>
        ...
        <p><span class="link" id="open_preferences_center">Cookies-Einstellungen aktualisieren</span></p>
        ...
        <p>Sie können darüber hinaus die Erfassung der durch das Cookie erzeugten und auf Ihre Nutzung der Website bezogenen Daten (inkl. Ihrer IP-Adresse) sowie die Verarbeitung dieser Daten durch Google verhindern, indem Sie ein Browser-Add-on herunterladen und installieren</p>
        ...
        <p>a) Facebook</p>
        <p>Auf unserer Website kommen Social-Media Plug-ins von Facebook zum Einsatz, um deren Nutzung persönlicher zu gestalten. Hierfür nutzen wir den „LIKE“ oder „TEILEN“-Button. Es handelt sich dabei um ein Angebot von Facebook. Wenn Sie eine Seite unseres Webauftritts aufrufen, die ein solches Plug-in enthält, baut Ihr Browser eine direkte Verbindung mit den Servern von Facebook auf. Der Inhalt des Plug-ins wird von Facebook direkt an Ihren Browser übermittelt und von diesem in die Webseite eingebunden.</p>
        ...
        <p>Sind Sie bei Facebook eingeloggt, kann Facebook den Besuch unserer Website Ihrem Facebook-Konto direkt zuordnen. Wenn Sie mit den Plug-ins interagieren, zum Beispiel den „LIKE“ oder „TEILEN“-Button betätigen, wird die entsprechende Information ebenfalls direkt an einen Server von</p>
        <p>Facebook übermittelt und dort gespeichert. Die Informationen werden zudem auf Facebook veröffentlicht und Ihren Facebook-Freunden angezeigt.</p>
        ...
        <p>Möchten Sie von Ihrem Widerrufs- oder Widerspruchsrecht Gebrauch machen, genügt eine E-Mail an dialog@tkgad.com.</p>
